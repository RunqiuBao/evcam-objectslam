...
<img src="./assets/images/rgb-sample.png" alt="RGB image sample." width="300" height="180" title="RGB image sample">
<br>
, while output of an event camera looks like this:
<br>
<img src="./assets/images/event-sample.png" alt="event data sample." width="300" height="180" title="Event data sample">
<br>
...
```
Because event camera captures temporal gradients of light field intensity, 
it is much faster than normal integration-based camera!
```
